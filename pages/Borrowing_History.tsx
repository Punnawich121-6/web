            ...
            <div className="p-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  คุณต้องการส่งคำขอคืนอุปกรณ์{" "}
                  <strong>{recordToReturn.equipmentName}</strong> (จำนวน{" "}
                  {recordToReturn.quantity}) ใช่หรือไม่?
                </p>
                <p className="text-xs text-gray-500 mb-4">
                  หลังจากยืนยัน สถานะจะเปลี่ยนเป็น "รอตรวจสอบการคืน"
                  และเจ้าหน้าที่จะต้องยืนยันการรับคืนอุปกรณ์อีกครั้ง
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 mt-6">
                ...
                <button
                  ...
                  disabled={returnLoading}
                  className="w-full px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-sm font-medium disabled:opacity-50 disabled:bg-green-400"
                >
                  {returnLoading ? (
